...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php // need to default this to reader and disable it for the creation of a new user. change then using edit ?>
		<?php //echo $form->dropDownList($model,'role_id',CHtml::encodeArray((User::model()->getRoleOptions())), array('disabled'=>false, 'options'=>array(1=>array('Reader'=>'selected')))); ?>
