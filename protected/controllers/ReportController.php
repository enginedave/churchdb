...
class ReportController extends Controller
{
	 ...
	 */
	public $layout='//layouts/column1report';
	...
	public function accessRules()
	{
		...
		return array(
			...
			array(
				'allow',
				'actions' => array('delete','admin','rpt1','rpt2'),
	...
	public function actionRpt2()
	{
		...
		$familyDataProvider = new CActiveDataProvider('Family', array(
			'pagination'=>array(
				'pageSize'=>999,
			),
		));
		$districtDataProvider = new CActiveDataProvider('District',array(
			'pagination'=>array(
				'pageSize'=>999,
			),
		));
		$this->render('rpt2', array(
			'familyDataProvider'=>$familyDataProvider,
			'districtDataProvider'=>$districtDataProvider,
			'peopleDataProvider'=>$peopleDataProvider,
		));
